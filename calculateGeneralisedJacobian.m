function [subdifferential,area,new_array] = calculateGeneralisedJacobian(logical_column_of_active_regions,set_of_regions_functions, point_array,variables_string)
    s = sum(logical_column_of_active_regions,1);
    b = size(varString2Array(variables_string),2);   
    new_array = zeros(s,b);
    count = 1;
    set_of_regions_functions
